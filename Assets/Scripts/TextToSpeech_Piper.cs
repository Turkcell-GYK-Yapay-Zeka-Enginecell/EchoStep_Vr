...
public class TextToSpeech_Piper : MonoBehaviourSingleton<TextToSpeech_Piper>
{

    public ModelAsset modelAsset;
    public ESpeakTokenizer tokenizer;

    public TextMeshProUGUI voiceNameText;
    ...
    public void OnSubmitText(TextMeshProUGUI textField)
    {
    ...
    private void _SynthesizeAndPlayChunk(string textChunk)
    {
        ...
        audioSource.Stop(); // Önce durdur
        audioSource.clip = clip; // Clip'i ata

        // ✅ Lip sync sistemini güncelle


        audioSource.Play(); // Sonra çal
    ...
    internal void GenerateSpeech(string text)
    {
